...
//public class eco extends JFrame{
    ...
    private  GroupLayout  makeuptab1Layout,  clothesTab2Layout, 
                   kitchenLayout1, suppliesLayout1,design1Layout,desgn2Layout,desgn3Layout, 
                panelImagesLayout, layout;
    private  JMenuBar MenuBar;
    private  JMenu Menu; 
   private   JMenuItem JmenuProducts, JmenuInventory,jmenuSales, jmenuLogout;
 ...
 //private ProductClass productClass;
    ...
    btnSearch.setBackground(new Color(89, 0, 54));
    btnSearch.setFont(new Font("Sitka Display", 1, 14));
    btnSearch.setForeground(new Color(236, 239, 241));
...
//    btncart.addActionListener(this);
    ...
    Menu.add(JmenuInventory);

    jmenuSales= new JMenuItem();
    ...
    designpanel.setBackground(new Color(236, 239, 241));
    ...
    designpanel2.setBackground(new Color(236, 239, 241));
...
//    DL6.setIcon(new ImageIcon(getClass().getResource("/EComPlatfrom/2bcc05929ada6c77c193a5ee48812f8e (1).jpg"))); // NOI18N
    ...
    desgnpanel3.setBackground(new Color(236, 239, 241));
...
//    DL10.setIcon(new ImageIcon(getClass().getResource("/EComPlatfrom/2bcc05929ada6c77c193a5ee48812f8e (1).jpg"))); // NOI18N
    ...
    .addGap(8, 8, 8)));
     ...
     // product panels for makeup stat: transferred into product class
        ...
        //MakeUpjScrollPane.add(makeupPanel);
...
//clothes
    ...
    clothes = new JPanel();
        ...
        clothesScrolpane.setViewportView(clothespanel);
         //clothesScrolpane.add(clothespanel);
...
//school supplies   
    ...
    page.setLocationRelativeTo(null);
     dispose();
    }else if(e.getSource()==JmenuInventory){
