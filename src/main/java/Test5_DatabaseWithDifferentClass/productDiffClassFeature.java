...
import Test4_InventoryReportsFunction.*;
 ...
 * @author Raylen
 */
public class productDiffClassFeature extends JFrame {
    
    Product pro = new Product();
    
     JCheckBox[] checkBoxes = pro.getAllCheckBoxes();
    ...
    public productDiffClassFeature(){
    ...
    checkBoxes[0] = new JCheckBox("Cellphone");
    gadget.add((checkBoxes[0]));
    
    JPanel makeup = new JPanel();
    checkBoxes[1] = new JCheckBox("Eyeshadow");
    makeup.add(checkBoxes[1]);
    
    JPanel schoolsup = new JPanel();
    checkBoxes[2] = new JCheckBox("Notebook");
    schoolsup.add(checkBoxes[2]);
   ...
   //(Quantity Prod 1)
    ...
    // using hashmap to easily group the category and product. why note looping? tried it. didnt work. 
    Map<String, JCheckBox[]> categoryMap = new HashMap<>();
    
    // PUTS the category and item in map
    categoryMap.put("Gadget", new JCheckBox[]{checkBoxes[0]});
    categoryMap.put("Makeup", new JCheckBox[]{checkBoxes[1]});
    categoryMap.put("School Supplies", new JCheckBox[]{checkBoxes[2]});
    ...
    try {
        ...
        // this loops to see what jcheckboxes are checked. whats .Entry you say? the name is at itself. its an 'entry'. what's an entrySet? its a set that contains the entries inside the map.
        //what's entry.getKey naman you ask? its returns the Key which is the category. for context, when using the entrySet you need a so called key and value. in here the key is category and value are the jboxes
        //
    ...
    productDiffClassFeature l = new productDiffClassFeature();
    l.setVisible(true);
