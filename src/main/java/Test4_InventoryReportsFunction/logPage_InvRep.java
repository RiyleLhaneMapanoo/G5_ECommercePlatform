 ...
 * @author Raylen
 */
public class logPage_InvRep extends JFrame {
    ...
    new JCheckBox("Cellphone"),
    new JCheckBox("Eyeshadow"),
    new JCheckBox("Notebook")
   };
    for (int i = 0; i < checkBoxes.length; i++) {
            checkBoxes[i].setBounds(20, 450 + (i * 30), 100, 25); // Positioning checkboxes vertically; basically what this does is automatically add and position newly created check boxes by adding a gap of 30 each
            add(checkBoxes[i]); // Add each checkbox to the frame
        }
